export default async function APIExerc1(){ // declaramos aqui que ela vai ser assíncrona com async, só com essa palavra será permitido adicionar o "await" ali abaixo.
